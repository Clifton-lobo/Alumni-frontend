  ...
  <AnimatePresence>
    {open && (
      <div
        ...
        onPointerDown={(e) => e.stopPropagation()} // ✅ stops Radix from seeing it
      >
        <motion.div
          ...
          onPointerDown={(e) => e.stopPropagation()} // ✅ same here
        ...
        >
          ...
          <button
            onClick={(e) => { e.stopPropagation(); onClose(); }}
            onPointerDown={(e) => e.stopPropagation()} // ✅ on X button too
