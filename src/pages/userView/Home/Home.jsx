...
const Home = () => {
  ...
  id="home"
  ref={heroRef}
  className="relative min-h-screen overflow-hidden bg-gradient-to-b from-[#00A3E0] via-[#38BDF8] to-white"
>
  ...
  <div className="absolute inset-0 overflow-hidden">
    <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-[#EBAB09]/10 blur-3xl" />
  ...
  <div className="relative z-10 container mx-auto px-4 pt-24 pb-20">
    <div className="max-w-4xl mx-auto text-center">
      ...
      {/* Heading */}
      <h1
        className={`font-serif text-3xl sm:text-4xl md:text-7xl font-bold text-white mb-4 leading-tight transition-all duration-700 ${
          heroVisible
      ...
      >
        <Link
          to="/user/community"
          className="px-8 py-4 rounded-xl bg-indigo-400 text-white font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition"
        >
        ...
        <Link
          to="/user/about"
          className="px-8 py-4 rounded-xl border border-white/70 text-white font-semibold hover:bg-white hover:text-[#00A3E0] transition"
        >
          About Us
        </Link>
      </div>
