  ...
  return (
    <div className="flex items-center justify-between mt-6 px-1">
      <p className="text-sm text-gray-400">
        Page {page} of {pages} · {pagination.total} jobs
      </p>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-800">
              ...
              <span>
                {applicant.stream || "Stream N/A"}, {applicant.batch || "Batch N/A"}
              </span>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-[#f4f6fb] p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 ml-12">
          Applications received for jobs you posted
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <StatCard
          icon={Briefcase}
          label="Jobs Posted by You"
          value={pagination.total}
          accent="#152A5D"
        />
        <StatCard
          icon={ClipboardList}
          label="Applications (this page)"
        ...
        {loading && (
          <div className="space-y-3 animate-pulse">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="rounded-2xl border border-gray-100 p-5 flex items-center gap-4"
              >
        ...
        {!loading && jobApplications.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-gray-400 text-sm mt-1">
              Applications to jobs you posted will appear here.
            </p>
          </div>
        )}
